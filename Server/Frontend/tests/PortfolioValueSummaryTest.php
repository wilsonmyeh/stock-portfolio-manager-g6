<?php
	...
	class PortfolioValueSummaryTest extends PHPUnit_Framework_TestCase
	{
		...
		public function testThatCorrectTotalPortfolioValueCanBeSetAndGet(){
			//Arrange
		    ...
		    try{
		        ...
		        //query the value directly from Yahoo
		        $newValue = 0;
		      ...
		      $stocks = array_keys($portfolioObj->getOwnedStock());
		      $stockObjects = $portfolioObj->getOwnedStock();
			...
			//Assert
			$this->assertEquals($newValue, $portfolioObj->getTotalValue(), "total net portfolio values from do not match when trying to get account summary information");
